...
public class Lab2App extends JFrame {
    ...
    private static void save() {
        if (editMode) {
            if (countryMode) {
                ...
                Country country = CountryDAO.findByName(textCityCountryName.getText());
                if (country == null) {
    ...
    private static void fillCityFields() {
        ...
        Country country = CountryDAO.findById(currentCity.getCountryId());
        assert country != null;
